...
class CASSIOperator(LinearOperator):
    ...
    def forward(self, data, **kwargs):
        ...
        if self.input_setting == 'H':
            ...
            input_meas = (input_meas -input_meas.min())/(input_meas.max()-input_meas.min())*2-1
        return input_meas
    def transpose(self, data, **kwargs):
